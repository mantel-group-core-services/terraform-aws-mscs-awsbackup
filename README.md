...
| <a name="input_daily_backup_plan_config"></a> [daily\_backup\_plan\_config](#input\_daily\_backup\_plan\_config) | Contains the general configuration of the Daily AWS Backup Plan. | <pre>object({<br>    enabled             = bool<br>    enable_vss          = bool<br>    name                = string<br>    start_window        = number<br>    completion_window   = number<br>    retention_in_days   = number<br>    schedule            = string<br>    selection_tag_key   = string<br>    selection_tag_value = string<br>    additional_selection_tags = list(object({<br>      key   = string<br>      value = string<br>      type  = string<br>    }))<br><br><br>  })</pre> | <pre>{<br>  "additional_selection_tags": [],<br>  "completion_window": 180,<br>  "enable_vss": false,<br>  "enabled": true,<br>  "name": "backupDaily",<br>  "retention_in_days": 35,<br>  "schedule": "cron(0 10 ? * * *)",<br>  "selection_tag_key": "backup",<br>  "selection_tag_value": "Daily",<br>  "start_window": 60<br>}</pre> | no |
| <a name="input_hourly_backup_plan_config"></a> [hourly\_backup\_plan\_config](#input\_hourly\_backup\_plan\_config) | Contains the general configuration of the Hourly AWS Backup Plan. | <pre>object({<br>    enabled             = bool<br>    enable_vss          = bool<br>    name                = string<br>    start_window        = number<br>    completion_window   = number<br>    retention_in_days   = number<br>    schedule            = string<br>    selection_tag_key   = string<br>    selection_tag_value = string<br>    additional_selection_tags = list(object({<br>      key   = string<br>      value = string<br>      type  = string<br>    }))<br>  })</pre> | <pre>{<br>  "additional_selection_tags": [],<br>  "completion_window": 180,<br>  "enable_vss": false,<br>  "enabled": true,<br>  "name": "backupHourly",<br>  "retention_in_days": 14,<br>  "schedule": "cron(0 * ? * * *)",<br>  "selection_tag_key": "backup",<br>  "selection_tag_value": "Daily",<br>  "start_window": 60<br>}</pre> | no |
...
| <a name="input_unscoped_backup_plan_config"></a> [unscoped\_backup\_plan\_config](#input\_unscoped\_backup\_plan\_config) | Contains the configuration of the Unscoped backup plan for untagged resources. | <pre>object({<br>    enabled                  = bool<br>    name                     = string<br>    start_window             = number<br>    completion_window        = number<br>    enable_continuous_backup = bool<br>    retention_in_days        = number<br>    selection_tag_key        = string<br>    schedule                 = string<br>    enable_vss               = bool<br>  })</pre> | <pre>{<br>  "completion_window": 180,<br>  "enable_continuous_backup": false,<br>  "enable_vss": false,<br>  "enabled": true,<br>  "name": "mgms_unscoped_backup_plan",<br>  "retention_in_days": 14,<br>  "schedule": "cron(0 10 ? * * *)",<br>  "selection_tag_key": "backup",<br>  "start_window": 60<br>}</pre> | no |
...
| <a name="input_weekly_backup_plan_config"></a> [weekly\_backup\_plan\_config](#input\_weekly\_backup\_plan\_config) | Contains the general configuration of the Weekly AWS Backup Plan. | <pre>object({<br>    enabled             = bool<br>    enable_vss          = bool<br>    name                = string<br>    start_window        = number<br>    completion_window   = number<br>    retention_in_days   = number<br>    schedule            = string<br>    selection_tag_key   = string<br>    selection_tag_value = string<br>    additional_selection_tags = list(object({<br>      key   = string<br>      value = string<br>      type  = string<br>    }))<br>  })</pre> | <pre>{<br>  "additional_selection_tags": [],<br>  "completion_window": 480,<br>  "enable_vss": false,<br>  "enabled": true,<br>  "name": "backupWeekly",<br>  "retention_in_days": 105,<br>  "schedule": "cron(0 10 ? * FRI *)",<br>  "selection_tag_key": "backup",<br>  "selection_tag_value": "Weekly",<br>  "start_window": 60<br>}</pre> | no |
| <a name="input_yearly_backup_plan_config"></a> [yearly\_backup\_plan\_config](#input\_yearly\_backup\_plan\_config) | Contains the general configuration of the Yearly AWS Backup Plan. | <pre>object({<br>    enabled             = bool<br>    enable_vss          = bool<br>    name                = string<br>    start_window        = number<br>    completion_window   = number<br>    retention_in_days   = number<br>    schedule            = string<br>    selection_tag_key   = string<br>    selection_tag_value = string<br>    additional_selection_tags = list(object({<br>      key   = string<br>      value = string<br>      type  = string<br>    }))<br>  })</pre> | <pre>{<br>  "additional_selection_tags": [],<br>  "completion_window": 480,<br>  "enable_vss": false,<br>  "enabled": true,<br>  "name": "backupYearly",<br>  "retention_in_days": 765,<br>  "schedule": "cron(0 19 1 1 ? *)",<br>  "selection_tag_key": "backup",<br>  "selection_tag_value": "Yearly",<br>  "start_window": 60<br>}</pre> | no |
