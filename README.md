...
|------|-------------|------|---------|:--------:|
| <a name="input_additional_backup_plan_config"></a> [additional\_backup\_plan\_config](#input\_additional\_backup\_plan\_config) | Contains the general configuration of an AWS Backup Plan. This can be used to set any number of arbitrary additional Backup Plans. | <pre>map(object({<br>    completion_window        = number<br>    enable_continuous_backup = bool<br>    enable_vss               = bool<br>    name                     = string<br>    retention_in_days        = number<br>    schedule                 = string<br>    selection_tag_key        = string<br>    selection_tag_value      = string<br>    start_window             = number<br>    cold_storage_after       = optional(number)<br>    additional_selection_tags = optional(list(object({<br>      key   = string<br>      value = string<br>      type  = string<br>    })))<br>  }))</pre> | `{}` | no |
...
| <a name="input_weekly_backup_plan_config"></a> [weekly\_backup\_plan\_config](#input\_weekly\_backup\_plan\_config) | Contains the general configuration of the Weekly AWS Backup Plan. | <pre>object({<br>    completion_window   = number<br>    enabled             = bool<br>    enable_vss          = bool<br>    name                = string<br>    retention_in_days   = number<br>    schedule            = string<br>    selection_tag_key   = string<br>    selection_tag_value = string<br>    start_window        = number<br>    cold_storage_after  = optional(number)<br>    additional_selection_tags = optional(list(object({<br>      key   = string<br>      value = string<br>      type  = string<br>    })))<br>  })</pre> | <pre>{<br>  "completion_window": 480,<br>  "enable_vss": false,<br>  "enabled": true,<br>  "name": "backupWeekly",<br>  "retention_in_days": 105,<br>  "schedule": "cron(0 10 ? * FRI *)",<br>  "selection_tag_key": "backup",<br>  "selection_tag_value": "Weekly",<br>  "start_window": 60<br>}</pre> | no |
| <a name="input_yearly_backup_plan_config"></a> [yearly\_backup\_plan\_config](#input\_yearly\_backup\_plan\_config) | Contains the general configuration of the Yearly AWS Backup Plan. | <pre>object({<br>    completion_window   = number<br>    enabled             = bool<br>    enable_vss          = bool<br>    name                = string<br>    retention_in_days   = number<br>    schedule            = string<br>    selection_tag_key   = string<br>    selection_tag_value = string<br>    start_window        = number<br>    cold_storage_after  = optional(number)<br>    additional_selection_tags = optional(list(object({<br>      key   = string<br>      value = string<br>      type  = string<br>    })))<br>  })</pre> | <pre>{<br>  "completion_window": 480,<br>  "enable_vss": false,<br>  "enabled": true,<br>  "name": "backupYearly",<br>  "retention_in_days": 765,<br>  "schedule": "cron(0 19 1 1 ? *)",<br>  "selection_tag_key": "backup",<br>  "selection_tag_value": "Yearly",<br>  "start_window": 60<br>}</pre> | no |
